      ...
      <div className="container mx-auto px-4 pt-20 relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in">
            Transforming <span className="text-heramb-red">Industries</span>, <br />
            Empowering <span className="text-heramb-red">Tomorrow</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-200 mb-8 animate-fade-in animate-delay-200">
            Heramb delivers innovative solutions designed to meet the most challenging industry demands, driving sustainable growth and operational excellence.
          </p>
